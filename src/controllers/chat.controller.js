...
class ChatController {
  ...
  async streamMessage(req, res, next) {
    try {
      ...
      const conversationId = req.query.conversationId ? parseInt(req.query.conversationId) : null;
      ...
      const result = await chatService.sendMessageStream(conversationId, message, {
        onStatus: (statusText) => {
